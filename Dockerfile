...
RUN torch-model-archiver --model-name model --version 1.0 --model-file model_dir/model.pth --handler handler.py --extra-files "model.py" --export-path model-store